...
filename = 'everest_slice_Temp_' + str(sys.argv[1]).zfill(4) + '.png'
dt = int(sys.argv[1])
...
temp_range=cell.CellData['TEMPERATURE'].GetRange(0)
print(temp_range)
...
# create a new 'Extract Block'
cell_Slices = ExtractBlock(registrationName='Cell_Slices', Input=extractTimeSteps1)
...
tEMPERATURELUT.RescaleTransferFunction(temp_range[0], temp_range[1])
tEMPERATURELUT.RGBPoints = [0.0, 0.0, 0.0, 0.0, 499.49999999999994, 0.501960784314, 0.0, 0.0, 999.0, 1.0, 0.501960784314, 0.0, 1500.0, 1.0, 1.0, 1.0]
tEMPERATURELUT.ColorSpace = 'RGB'
#tEMPERATURELUT.ScalarRangeInitialized = 0.0
...
slice1Display.RescaleTransferFunctionToDataRange(True, True)
...
slice2Display.RescaleTransferFunctionToDataRange(True, True)
...
#tEMPERATUREPWF.Points = [0.0, 0.0, 0.5, 0.0, 1500.0, 1.0, 0.5, 0.0]
#tEMPERATUREPWF.ScalarRangeInitialized = 0
