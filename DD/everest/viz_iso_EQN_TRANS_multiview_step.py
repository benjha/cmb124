...
filename = 'everest_Multiview_' + str(sys.argv[1]).zfill(4) + '.png'
dt = int(sys.argv[1])
n_streams = 400
...
renderView2.ViewSize = [656, 363]
renderView2.InteractionMode = '2D'
renderView2.AxesGrid = 'GridAxes3DActor'
renderView2.OrientationAxesVisibility = 0
renderView2.CenterOfRotation = [0.0038862526416778564, 0.0, -0.004494160413742065]
renderView2.StereoType = 'Crystal Eyes'
renderView2.CameraPosition = [-0.041298830267369656, -0.6737775533219668, -0.03478359028914388]
renderView2.CameraFocalPoint = [-0.041298830267369656, 0.0, -0.03478359028914388]
...
renderView3.CameraPosition = [-0.5067509234783554, -0.0017437324823222737, -0.0318330021094558]
renderView3.CameraFocalPoint = [0.04728114977478981, -0.0017437324823222737, -0.0318330021094558]
...
threshold1.ThresholdRange = [0.0, 350.0]

# create a new 'Extract Block'
intakeExhaust_Geometry = ExtractBlock(Input=extractTimeSteps1)
intakeExhaust_Geometry.BlockIndices = [15, 14, 8, 5, 21, 7, 20, 6, 23, 22, 17, 3, 16, 19, 13, 12]
...
velocityLUT.RGBPoints = [0.0, 0.278431372549, 0.278431372549, 0.858823529412, 21.45, 0.0, 0.0, 0.360784313725, 42.74999999999999, 0.0, 1.0, 1.0, 64.35, 0.0, 0.501960784314, 0.0, 85.64999999999999, 1.0, 1.0, 0.0, 107.1, 1.0, 0.380392156863, 0.0, 128.55, 0.419607843137, 0.0, 0.0, 150.0, 0.878431372549, 0.301960784314, 0.301960784314]
...
intake_FrontStreamTracerDisplay.LineWidth = 0.5
...
intake_BackStreamTracerDisplay.LineWidth = 0.5
...
exhaust_FrontStreamTracerDisplay.LineWidth = 0.5
...
exhaust_BackStreamTracerDisplay.LineWidth = 0.5
...
lowDisplay.FontSize = 13
lowDisplay.WindowLocation = 'AnyLocation'
lowDisplay.Position = [0.12415525114155251, 0.05117014893617014]
...
highDisplay.FontSize = 13
highDisplay.WindowLocation = 'AnyLocation'
highDisplay.Position = [0.124155, 0.537872]
...
velocityLUTColorBar.Position = [0.07686453576864535, 0.07446808510638303]
...
velocityLUTColorBar.ScalarBarLength = 0.5106382978723388
...
contour1Display.SpecularColor = [1.0, 1.0, 0.0]
contour1Display.SpecularPower = 19.0
...
pythonAnnotation1Display.FontSize = 16
pythonAnnotation1Display.WindowLocation = 'AnyLocation'
pythonAnnotation1Display.Position = [0.03591463414634145, 0.8219562672176309]
...
dp_FROM_NOZZLELUT.NumberOfTableValues = 1
dp_FROM_NOZZLELUT.ScalarRangeInitialized = 1.0
dp_FROM_NOZZLELUT.Annotations = ['0', '0', '1', '1']
dp_FROM_NOZZLELUT.ActiveAnnotatedValues = ['0', '1', '0', '1', '0', '1']
dp_FROM_NOZZLELUT.IndexedColors = [0.8274509803921568, 0.27450980392156865, 0.0, 1.0, 0.3333333333333333, 0.0]
...
dp_FROM_NOZZLEPWF.Points = [0.0, 1.0, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]
...
threshold1Display.ScaleFactor = 0.011345801409333944
threshold1Display.SelectScaleArray = 'None'
threshold1Display.GlyphType = 'Arrow'
threshold1Display.GlyphTableIndexArray = 'None'
threshold1Display.GaussianRadius = 0.0005672900704666973
...
threshold1Display.ScalarOpacityUnitDistance = 0.0046999359269633365
...
intake_FrontStreamTracerDisplay_1.LineWidth = 0.5
...
intake_BackStreamTracerDisplay_1.LineWidth = 0.5
...
exhaust_FrontStreamTracerDisplay_1.LineWidth = 0.5
...
exhaust_BackStreamTracerDisplay_1.LineWidth = 0.5
...
intake_FrontStreamTracerDisplay_2.LineWidth = 0.5
...
intake_BackStreamTracerDisplay_2.LineWidth = 0.5
...
contour1Display_1.AmbientColor = [0.6666666666666666, 0.0, 0.0]
contour1Display_1.ColorArrayName = ['POINTS', '']
contour1Display_1.DiffuseColor = [0.6666666666666666, 0.0, 0.0]
contour1Display_1.Specular = 1.0
contour1Display_1.SpecularColor = [1.0, 1.0, 0.0]
contour1Display_1.SpecularPower = 19.0
...
# trace defaults for the display properties.
threshold1Display_1.Representation = 'Points'
...
threshold1Display_1.ScaleFactor = 0.011345801409333944
...
threshold1Display_1.GaussianRadius = 0.0005672900704666973
...
threshold1Display_1.ScalarOpacityUnitDistance = 0.0046999359269633365
...
contour1Display_2.AmbientColor = [0.6666666666666666, 0.0, 0.0]
contour1Display_2.ColorArrayName = ['POINTS', '']
contour1Display_2.DiffuseColor = [0.6666666666666666, 0.0, 0.0]
contour1Display_2.Specular = 1.0
contour1Display_2.SpecularColor = [1.0, 1.0, 0.0]
contour1Display_2.SpecularPower = 19.0
...
# trace defaults for the display properties.
threshold1Display_2.Representation = 'Points'
...
threshold1Display_2.ScaleFactor = 0.011375310271978379
...
threshold1Display_2.GaussianRadius = 0.000568765513598919
...
threshold1Display_2.ScalarOpacityUnitDistance = 0.00467015910513306
