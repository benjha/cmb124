...
# create a new 'Extract Block'
parcel = ExtractBlock(Input=pvpvd)
...
exhaust_BackStreamTracer.SeedType.Radius = 0.015
...
exhaust_FrontStreamTracer.SeedType.Radius = 0.015
...
intake_FrontStreamTracer.IntegratorType = 'Runge-Kutta 2'
...
intake_FrontStreamTracer.SeedType.NumberOfPoints = 150
intake_FrontStreamTracer.SeedType.Radius = 0.014
...
intake_BackStreamTracer.SeedType.Radius = 0.014
